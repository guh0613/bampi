...
try:
    ...
    logger.info(
        ...
        f"forward_enabled={plugin_config.bampi_forward_enabled} "
        f"forward_limits={plugin_config.bampi_forward_max_roots}/"
        f"{plugin_config.bampi_forward_max_nodes}/"
        f"{plugin_config.bampi_forward_max_depth} "
